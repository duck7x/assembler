...
int run_assembler_phase_2(char* file_name, LinkedCommandList_t action_names_list, LinkedList_t *data_memory_list, LabelsLinkedList_t *symbol_table, char *memory_array[], int *has_errors); /* TODO: Add documentation */
int create_files(char* file_name, char *memory_array[], LabelsLinkedList_t *symbol_table, int *has_errors); /* TODO: Add documentation */
