...
void create_files(char* file_name, char *memory_array[], LabelsLinkedList_t *symbol_table, Table_t *external_memory_table); /* TODO: Add documentation */
void delete_created_files(char *file_name); /* TODO: Add documentation */
