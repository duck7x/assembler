...
int run_assembler_phase_2(char* file_name, LinkedCommandList_t action_names_list, LinkedList_t *data_memory_list, Table_t *extern_memory_table, LabelsLinkedList_t *symbol_table, char *memory_array[]); /* TODO: Add documentation */
