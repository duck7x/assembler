assembler:	assembler.o assembler_phase.o pre_assembler_phase.o assembler_phase_functions.o pre_assembler_functions.o general_functions.o utils.o
	gcc -g -Wall -ansi -pedantic -o assembler assembler.o assembler_phase.o pre_assembler_phase.o assembler_phase_functions.o pre_assembler_functions.o general_functions.o utils.o -lm
