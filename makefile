assembler:	assembler.o assembler_phase.o pre_assembler_phase.o assembler_phase_functions.o pre_assembler_functions.o general_functions.o
	gcc -g -Wall -ansi -pedantic -o assembler assembler.o assembler_phase.o pre_assembler_phase.o assembler_phase_functions.o pre_assembler_functions.o general_functions.o
...
assembler_phase_functions.o:	assembler_phase_functions.c assembler_phase_functions.h general_functions.h
	gcc -c -g -Wall -ansi -pedantic -o assembler_phase_functions.o assembler_phase_functions.c
...
pre_assembler_functions.o:	pre_assembler_functions.c pre_assembler_functions.h general_functions.h
